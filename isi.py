...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m★\033[1;91m] \033[1;92mFACEBOOK : SALMAN MUHAMMAD
\033[1;91m [\033[1;94m★\033[1;91m] \033[1;92mFB GROUP : ANONYMOUS
\033[1;91m [\033[1;94m★\033[1;91m] \033[1;92mGITHUB   : HACKER-SALMAN
\033[1;91m [\033[1;94m★\033[1;91m] \033[1;92mWARNING  : I AM NOT RESPONSIBLE FOR ANY MISS YOU
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sOld Fb Cracker"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION   : %s1.5"%(G,R,G,B,G))
		print("")
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print("\n [*] Author    : SALMAN-PAKHTOON")
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/https://Mr.An0nym0us.420 ")
		print(" [*] Instagram : https://instagram.com/mr.anonymous.420")
		print(" [*] YouTube   : https://youtube.com/ANONYMOUS PAKHTOON")
		exit(" [*] GitHub    : https://github.com/HACKER-SALMAN")
	else:
		Main()
